...
if __name__ == '__main__':
    ...
    dt = DateToken()
    string_a = 'Try this date 12/01/1995'
    print(dt.us_date(string_a))
    string_b = 'Try this date 12/01/95'
    print(dt.us_date(string_b))
    string_c = 'Try this date 12-01-95'
    print(dt.us_date(string_c))
    string_d = 'Try this date 12-01-1995'
    print(dt.us_date(string_d))
    string_e = 'Try this date January 3rd, 1995'
    print(dt.us_date(string_e))
